...
export interface ProjectTokenAssociateInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "redirectForToken"
      | "tokenAssociate"
...
export interface ProjectTokenAssociate extends BaseContract {
  connect(runner?: ContractRunner | null): ProjectTokenAssociate;
  waitForDeployment(): Promise<this>;

  interface: ProjectTokenAssociateInterface;
